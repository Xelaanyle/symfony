...
class TagRepository extends ServiceEntityRepository
{
    ...
    /**
     * This method finds tags nased on a school year, by making inner joins 
     * with students and with tags.
     * @param SchoolYear $choolYear The school year for wich wew ant to find the tags
     * @return Tag[] Returns an array of Tag objects
     */
    public function findBySchoolYear(SchoolYear $schoolYear): array
    {
        ...
        return $this->createQueryBuilder('t')
            ...
            ->andWhere('sy = :schoolYearId')
            ->setParameter('schoolYearId', $schoolYear)
            ->orderBy('t.name', 'ASC')
            ->getQuery()
            ->getResult()
            ;
